...
print("4) Svobody")
a=tonumber(io.read())
if a==3 then i=i+1 print("Молодец!") else print("Плохо!") end
...
print("4) Udar kopuem")
a=tonumber(io.read())
if a==1 then i=i+1 print("Молодец!") else print("Плохо!") end
...
a=tonumber(io.read())
if a==2 then i=i+1 print("Молодец!") else print("Плохо!") end
...
a=tonumber(io.read())
if a==4 then i=i+1 print("Молодец!") else print("Плохо!") end
